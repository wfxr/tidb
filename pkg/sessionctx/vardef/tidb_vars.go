...
const (
	...
	// TiDBEnableForShareSharedLock indicates whether `select for share` uses the shared-lock path.
	TiDBEnableForShareSharedLock = "tidb_enable_for_share_shared_lock"
...
const (
	...
	DefTiDBEnableForShareSharedLock                   = false
